...
public class paciente {
    ...
    private String doctor; // Esto puede ser un objeto tipo Doctor si tienes una clase Doctor
    ...
    public void setHorarioCita(String horarioCita) { this.horarioCita = horarioCita; }
    ...
    public void setNumeroConsultas(int numeroConsultas) { this.numeroConsultas = numeroConsultas; }
